...
//        adImg.frame = [UIScreen mainScreen].bounds;
    ...
    [tabBar addBarButtonWithNorName:@"tabbar_icon_found_normal"  andDisName:@"tabbar_icon_found_highlight" andTitle:@"视频"];
    [tabBar addBarButtonWithNorName:@"tabbar_icon_media_normal" andDisName:@"tabbar_icon_media_highlight" andTitle:@"小说"];
    [tabBar addBarButtonWithNorName:@"tabbar_icon_found_normal" andDisName:@"tabbar_icon_found_highlight" andTitle:@"生活"];
